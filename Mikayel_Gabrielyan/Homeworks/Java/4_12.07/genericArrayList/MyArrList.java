...
public class MyArrList<T extends Number> {
    private int m_size = 0;
    private Number[] m_myArrList;
    private static int m_capacity = 16;
    private static float m_loadFactor = 0.75f;
    public MyArrList() {
        m_myArrList = new Number[m_capacity];
    }
    ...
    public void insert(int index, T value) throws IndexOutOfBoundsException {
        ...
        ++m_size;
        Number[] tmpArr = Arrays.copyOf(m_myArrList, m_capacity);

...
void inputArray(int array[], const int size) {            // The method requares input of numbers in array by the  user
    for (int i = 0; i < size; ++i) {
        std::cout << "array[" << i << "]= ";
        std::cin >> array[i]; 
    }
}
void printingArray(int array[], const int size) {    // Prints array
    for (int i = 0; i < 10; ++i) {
        std :: cout << array[i] << " ";
    }
    std :: cout << std :: endl;
